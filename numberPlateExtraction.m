...
f=imread('1.jpg'); % Reading the number plate image.
...
if ~isempty(r) % If succesfully indices of desired boxes are achieved.
    ...
    filename = 'noPlate.txt';
    filepath = 'C:\Users\chait\Desktop\Number_Plate_Extraction';
    file = fullfile(filepath,filename);
    fid = fopen(file, 'wt');
    fprintf(fid,'%s\n',noPlate);
    fclose(fid);
    winopen('C:\Users\chait\Desktop\Number_Plate_Extraction\noPlate.txt')
